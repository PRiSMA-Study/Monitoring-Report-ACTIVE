---
title: "<span style='font-size: 18px'> <span style='text-align: center'> PRISMA & ReMAPP Monitoring Report (Issued: 2024-01-30)"
output:
  pdf_document:
    toc: no
    toc_depth: 4
...
**Included data last updated in Synapse:** 2024-01-26
...
tb_enroll <- MatData_Screen_Enroll %>%
  ...
  summarise("Screened, n" = sum(SCREEN == 1, na.rm=TRUE),
            ...
            "Enrolled, n(%)^b^" = paste0(sum(ENROLL == 1, na.rm=TRUE),
              ...
              "Enrolled in 1st trimester, n(%)^c^" = paste0(sum(BOE_GA_WKS_ENROLL < 14, na.rm = TRUE)," (",
...
### Figure 1a: Cumulative enrollment in PRISMA by site
...
enroll_cum <- bind_rows(enroll_cum, new_row)
...
###  Figure 1b: Cumulative actual versus expected enrollment in PRISMA by site
...
### Figure 2: Distribution of gestational ages of participants who passed the IPC window and do not yet have a pregnancy outcome reported
...
figure2 <- MatData_Ipc_Visits_Mat %>%
  ...
  select(SITE, MOMID, PREGID, EST_CONCEP_DATE, CLOSED_OUT, M23_CLOSE_DSSTDAT) %>%
...
### Figure 3a. Heat maps of form completion for ANC visits in PRISMA 
...
### Figure 3b. Heat maps of form completion for PNC visits in PRISMA 
...
ggplot(data = MatData_Hb_GA_Visit,
  ...
  geom_point(alpha = 0.25)  +
    ...
    theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust=1),
        ...
        strip.text = element_text(size = 8) # You can modify the size as needed
        ) +
