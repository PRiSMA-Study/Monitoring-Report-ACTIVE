---
title: "<span style='font-size: 18px'> <span style='text-align: center'> PRISMA & ReMAPP Monitoring Report (Issued: 2023-10-24)"
output:
  html_document:
    df_print: paged
    toc: yes
...
##### Kenya : 2023-10-12 {.unlisted .unnumbered}
##### Pakistan : 2023-10-06 {.unlisted .unnumbered}
##### Ghana : 2023-09-28 {.unlisted .unnumbered}
##### Zambia : 2023-10-05 {.unlisted .unnumbered}
##### India CMC : 2023-09-29 {.unlisted .unnumbered}
...
bind_rows(ga_tb, 
  ...
  mutate_all(funs(str_replace(., "NaN", "0"))) %>% 
  kbl(caption = "", booktabs = TRUE) %>%  
    # footnote(alphabet = c("denominator is n completed any form with visit status=complete AND visit type=Enrollment AND passed on-time window with >19 weeks gestation",
...
```
<span style="font-size: 88%;">
^a^ denominator is n completed any form with visit status=complete AND visit type=Enrollment AND passed on-time window with >19 weeks gestation.
<br>
^b^ denominator is n completed any form with visit status=complete AND visit type=ANC20 AND passed on-time window with >22 weeks gestation. 
<br>
^c^ denominator is n completed any form with visit status=complete ANDvisit type=ANC28  AND passed on-time window with >30 weeks gestation. 
<br>
^d^ denominator is n completed any form with visit status=complete AND visit type=ANC32  AND passed on-time window with>33 weeks gestation. 
<br>
^e^ denominator is n completed any form with visit status=complete AND visit type=ANC36  AND passed on-time window with >38 weeks gestation. 
<br>
...
bind_rows(ga_tb, 
  ...
  kbl(caption = "", booktabs = TRUE) %>% #longtable = TRUE, 
    # footnote(alphabet = c("denominator is n completed any form with any visit status AND visit type=Enrollment AND passed on-time window with >19 weeks gestation",
...
```
<span style="font-size: 88%;">
^a^ denominator is n completed any form with any visit status AND visit type=Enrollment AND passed on-time window with >19 weeks gestation.
<br>
^b^ denominator is n completed any form with any visit status AND visit type=ANC20 AND passed on-time window with >22 weeks gestation.
<br>
^c^ denominator is n completed any form with any visit status AND visit type=ANC28 AND passed on-time window with >30 weeks gestation. 
<br>
^d^ denominator is n completed any form with any visit status AND visit type=ANC32 AND passed on-time window with>33 weeks gestation.
<br>
^e^ denominator is n completed any form with any visit status AND visit type=ANC36 AND passed on-time window with >38 weeks gestation.
<br>
^1^ MNH26 is only filled out for ReMAPP participants. 
^Note:^Passed window denominators for all visits are calculated by EDD reported in MNH01 (US_EDD_BRTHDAT). If an EDD is missing, the particpant is removed from this table.
</span>
...
*Value: Among women successfully contacted during the IPC period, are all expected forms for the visit complete? A visit is considered `complete` if the data reports the visit was conducted in person or by phone (variable name: `MAT_VISIT_MNHXX`). Goal: 100% completion for all forms, except MNH08 where lab results are expected to lag.*
<br>
```{r ipc table}
...
IPC %>% 
  ...
  mutate_all(funs(str_replace(., "NaN", "0"))) %>% 
  kbl(caption = "", booktabs = TRUE) %>% #longtable = TRUE, 
  # footnote(alphabet = c("denominator is n passed on-time window with >42 weeks gestation.",
  #                       "by form: have a complete visit status (variable name: `MAT_VISIT_MNHXX`) AND passed window for visit type = i with >42 weeks gestation.",
  #                       "denominator is n completed MNH09 or MNH10 or MNH11 with visit status=complete AND passed on-time window with >42 weeks gestation.")) %>% 
  kable_paper(bootstrap_options = "striped", 
              full_width = T, html_font = "Cambria", position = "left",
              latex_options = c("repeat_header", "HOLD_position")) %>% 
  kable_styling(font_size = 13) %>%
  ...
  pack_rows(paste0("IPC Visit Completion^a,b^"),1, 2, 
            label_row_css = "color: steelblue;") %>% 
  pack_rows("IPC Protocol Compliance^c,d^", 3, 5, 
            label_row_css = "color: steelblue;") 
```
<span style="font-size: 88%;">
^a^ numerator: have MNH09 or MNH10 or MNH11 with a complete visit status (variable name: `MAT_VISIT_MNHXX`).
<br>
^b^ denominator is n completed MNH09 or MNH10 or MNH11 with a complete visit status (variable name: `MAT_VISIT_MNHXX`) OR passed on-time window with >42 weeks gestation.
<br>
^c^ numerator: have a complete visit status (variable name: `MAT_VISIT_MNHXX`).
<br>
^d^ denominator is n completed MNH09 or MNH10 or MNH11 with visit status=complete.
</span>
...
bind_rows(birthoutcome,
  ...
  mutate_all(funs(str_replace(., "NaN", "0"))) %>%
  kbl(caption = "",  booktabs = TRUE) %>% #longtable = TRUE,
    # footnote(alphabet = c("denominator is n completed any form with visit status=complete AND visit type=PNC0 AND passed on-time window with >5 days postpartum",
    #                   "denominator is n completed any form with visit status=complete AND visit type=PNC1 AND passed on-time window with 14 days postpartum",
    #                   "denominator is n completed any form with visit status=complete AND visit type=PNC4 AND passed on-time window with >35 days postpartum",
    #                   "denominator is n completed any form with visit status=complete AND visit type=PNC6 AND passed on-time window with >7 wks postpartum",
    #                   "denominator is n completed any form with visit status=complete AND visit type=PNC26 AND passed on-time window with >28 wks postpartum",
    #                   "denominator is n completed any form wit visit status=complete AND visit type=PNC52 AND passed on-time window with >54 wks postpartum"),
...
```
<span style="font-size: 88%;">
^a^ denominator is n completed any form with visit status=complete AND visit type=PNC0 AND passed on-time window with >5 days postpartum. 
<br>
^b^ denominator is n completed any form with visit status=complete AND visit type=PNC1 AND passed on-time window with 14 days postpartum. 
<br>
^c^ denominator is n completed any form with visit status=complete AND visit type=PNC4 AND passed on-time window with >35 days postpartum. 
<br>
^d^ denominator is n completed any form with visit status=complete AND visit type=PNC6 AND passed on-time window with >7 wks postpartum. 
<br>
^e^ denominator is n completed any form with visit status=complete AND visit type=PNC26 AND passed on-time window with >28 wks postpartum. 
<br>
^f^ denominator is n completed any form wit visit status=complete AND visit type=PNC52 AND passed on-time window with >54 wks postpartum.
<br>
...
bind_rows(birthoutcome,
  ...
  mutate_all(funs(str_replace(., "NaN", "0"))) %>%
  kbl(caption = "", booktabs = TRUE) %>% #longtable = TRUE, 
    # footnote(alphabet = c("denominator is n completed any form with any visit status AND visit type=PNC0 AND passed on-time window with >5 days postpartum",
    #                   "denominator is n completed any form with any visit status AND visit type=PNC1 AND passed on-time window with 14 days postpartum",
    #                   "denominator is n completed any form with any visit status AND visit type=PNC4 AND passed on-time window with >35 days postpartum",
    #                   "denominator is n completed any form with any visit status AND visit type=PNC6 AND passed on-time window with >7 wks postpartum",
    #                   "denominator is n completed any form with any visit status AND visit type=PNC26 AND passed on-time window with >28 wks postpartum",
    #                   "denominator is n completed any form with any visit status AND visit type=PNC52 AND passed on-time window with >54 wks postpartum"),
    #          general = "Passed window denominators for all visits are calculated by date and time of birth reported in MNH09. If an date of birth is missing, the particpant is removed from this table.",
    #          number = "n is any participant with any birth outcome defined by `BIRTH_DSTERM_INFX` in MNH09",
    #          footnote_order = c("number", "alphabet", "general")) %>%
  kable_paper(bootstrap_options = "striped",
...
```
<span style="font-size: 88%;">
^a^ denominator is n completed any form with any visit status AND visit type=PNC0 AND passed on-time window with >5 days postpartum. 
<br>
^b^ denominator is n completed any form with any visit status AND visit type=PNC1 AND passed on-time window with 14 days postpartum. 
<br>
^c^ denominator is n completed any form with any visit status AND visit type=PNC4 AND passed on-time window with >35 days postpartum. 
<br>
^d^ denominator is n completed any form with any visit status AND visit type=PNC6 AND passed on-time window with >7 wks postpartum. 
<br>
^e^ denominator is n completed any form with any visit status AND visit type=PNC26 AND passed on-time window with >28 wks postpartum. 
<br>
^f^ denominator is n completed any form with any visit status AND visit type=PNC52 AND passed on-time window with >54 wks postpartum.
<br>
^1^ n is any participant with any birth outcome defined by `BIRTH_DSTERM_INFX` in MNH09.  
Note: Passed window denominators for all visits are calculated by date and time of birth reported in MNH09. If an date of birth is missing, the particpant is removed from this table.
</span>
...
out_tb %>%
  ...
  mutate_all(funs(str_replace(., "NaN", "0"))) %>%
  kbl(caption = "", booktabs = TRUE) %>% #longtable = TRUE, 
    # footnote(alphabet = c("denominator is n completed any form with visit status=complete AND visit type=ANC20 AND passed on-time window with >22 weeks gestation \nOR\n completed any form with visit status=complete AND visit type=ENROLLMENT (if combined ENROLLEMNT visit) AND passed on-time window with >19 weeks gestation",
    #                       
    #               "denominator is n completed any form with visit status=complete AND visit type=ANC32 AND passed on-time window with >33 weeks gestation \nOR\n completed any form with visit status=complete AND visit type=ANC36 (if missed ANC32) AND passed on-time window with >38 weeks gestation",
    #               
    #               "denominator is n completed any form with visit status=complete AND visit type=PNC6 AND passed on-time window with >7 weeks postpartum"),
...
```
<span style="font-size: 88%;">
^a^ denominator is n completed any form with visit status=complete AND visit type=ANC20 AND passed on-time window with >22 weeks gestation
<br>
OR
<br>
completed any form with visit status=complete AND visit type=ENROLLMENT (if combined ENROLLEMNT visit) AND passed on-time window with >19 weeks gestation. 
<br>
^b^ denominator is n completed any form with visit status=complete AND visit type=ANC32 AND passed on-time window with >33 weeks gestation 
<br>
OR
<br>
completed any form with visit status=complete AND visit type=ANC36 (if missed ANC32) AND passed on-time window with >38 weeks gestation
<br>
^c^ denominator is n completed any form with visit status=complete AND visit type=PNC6 AND passed on-time window with >7 weeks postpartum
<br>
^1^ n is any participant with any birth outcome defined by `BIRTH_DSTERM_INFX` in MNH09. 
<br>
