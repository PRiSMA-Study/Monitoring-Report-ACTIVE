---
title: "<span style='font-size: 18px'> <span style='text-align: center'> PRISMA & ReMAPP Monitoring Report (Issued: 2024-01-10)"
output:
  pdf_document:
    toc: no
    toc_depth: 4
...
**Includes data from synapse last updated:** 2023-12-08
...
### Figure 2: Distribution of gestational age of participants who passed the IPC window and do not yet have a pregnancy outcome reported

*Value:* Among participants who have passed their IPC window and do not have any IPC forms, how overdue are they? Distributions of estimated gestational age at the time of data upload is shown below.
...
ggplot(data = figure2, aes(x = AGE_AT_UPLOAD_DAYS)) +
  ...
  xlab("Estimated Gestational Age At Time of Upload (weeks)") +
  ylab("Count")
...
### Figure 3a. ANC Data Availability, by Form and Visit (Heat maps)
*Value:* Among women who are passed due or have had the visit, what percent of forms are complete? 
*Numerator:* By form: visit type = i (variable name: `TYPE_VISIT`) AND have a complete visit status (where variable name: `MAT_VISIT_MNHXX`=1 or 2) AND passed late window for visit type = i
...
out1  <- heat_map_data_anc %>% 
  ...
  xlab("Form") +
  ggtitle(paste0(UNIQUE_VISITS[1])) +
  guides(fill = guide_legend(reverse = TRUE)) +
  theme_minimal() +
  theme(legend.position = "bottom",
        axis.text.x = element_text(size = 8, face = "bold",),
        axis.title.x = element_text(colour = "black", size = 10, face = "bold", margin = margin(t = 20, r = 20, b = 0, l = 0)),
...
out2  <- heat_map_data_anc %>%
  ...
  labs(fill = str_wrap("Percent Complete", width = 8)) +
  xlab("Form") +
  ggtitle(paste0(UNIQUE_VISITS[2])) +
  guides(fill = guide_legend(reverse = TRUE)) +
  theme_minimal() +
  theme(legend.position = "bottom",
        axis.text.x = element_text(size = 8, face = "bold",),
...
out3  <- heat_map_data_anc %>% 
  ...
  labs(fill = str_wrap("Percent Complete", width = 8)) +
  xlab("Form") +
  ggtitle(paste0(UNIQUE_VISITS[3])) +
  guides(fill = guide_legend(reverse = TRUE)) +
  theme_minimal() +
  theme(legend.position = "bottom",
        axis.text.x = element_text(size = 8, face = "bold",),
...
out4  <- heat_map_data_anc %>% 
  ...
  labs(fill = str_wrap("Percent Complete", width = 8)) +
  xlab("Form") +
  ggtitle(paste0(UNIQUE_VISITS[4])) +
  guides(fill = guide_legend(reverse = TRUE)) +
  theme_minimal() +
  theme(legend.position = "bottom",
        axis.text.x = element_text(size = 8, face = "bold",),
...
out5  <- heat_map_data_anc %>% 
  ...
  xlab("Form") +
  ggtitle(paste0(UNIQUE_VISITS[5])) +
  guides(fill = guide_legend(reverse = TRUE)) +
  theme_minimal() +
  theme(legend.position = "bottom",
        axis.text.x = element_text(size = 8, face = "bold",),
...
### Figure 3b. PNC Data Availability, by Form and Visit (Heat maps)
*Value:* Among women who are passed due or have had the visit, what percent of forms are complete? 
*Numerator:* By form: visit type = i (variable name: `TYPE_VISIT`) AND have a complete visit status (where variable name: `MAT_VISIT_MNHXX`=1 or 2) AND passed late window for visit type = i
...
out1  <- heat_map_data_pnc %>%
  ...
  theme(legend.position = "bottom",
        ...
        plot.margin = margin(t = 20, r = 10, b = 10, l = 10),
        plot.caption = element_text(hjust = 0, size = 8, margin = margin(t = 10), vjust = 0)) + 
  coord_fixed(ratio = 0.15)  # Adjust the ratio to make the tiles shorter
...
out6  <- heat_map_data_pnc %>% 
  ...
  labs(fill = str_wrap("Percent Complete", width = 8)) +
  xlab("Form") +
  ggtitle(paste0(UNIQUE_VISITS[6])) +
  guides(fill = guide_legend(reverse = TRUE)) +
  theme_minimal() +
  theme(legend.position = "bottom",
        axis.text.x = element_text(size = 8, face = "bold",),
