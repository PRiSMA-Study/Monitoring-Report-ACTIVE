---
title: "<span style='font-size: 18px'> <span style='text-align: center'> PRISMA & ReMAPP Monitoring Report (Issued: 2024-08-27)"
output:
  pdf_document:
    toc: no
    toc_depth: 4
  ...
  tb <- matrix %>% 
    ...
    tab_style(
      style = list(
        ...
        cell_text(color = "white", size = px(30))
      ),
      locations = list(
        cells_title()
      )
    ...
    tab_style(
      style = list(
        ...
        cell_text(color = "black", size = px(30)),
        cell_text(v_align = "middle") 
      ),
      locations = list(
        cells_stubhead(),
    ...
    tab_style(
      style = list(
        ...
        cell_text(v_align = "middle", size = px(30))
      ),
      locations = list(
        cells_stub()
      ) 
    ...
    tab_style(
      style = list(
        cell_text(align = "center", size = px(30)) 
      ),
      locations = list(
...
**Date issued:** 2024-08-27

**Included data last updated in Synapse:** 2024-08-23 (Pakistan: 2024-08-16)
...
-   Ghana: 2024-08-16
-   Zambia: 2024-07-11
-   India CMC: 2024-08-09
-   India SAS: 2024-08-16
