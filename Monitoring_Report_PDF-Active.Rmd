---
title: "<span style='font-size: 18px'> <span style='text-align: center'> PRISMA & ReMAPP Monitoring Report (Issued: 2024-11-19)"
output:
  pdf_document:
    toc: no
    toc_depth: 4
...
**Date issued:** 2024-11-19

**Included data last updated in Synapse:** 2024-11-15
...
-   Ghana: 2024-11-14
-   Zambia: 2024-11-06
-   India CMC: 2024-11-01
-   India SAS: 2024-11-08
...
# set levels for percent bins
inf_heat_map_data_pnc$PCT_BIN <- factor(inf_heat_map_data_pnc$PCT_BIN, levels = c("Form not required", "0-9", "10-19", "20-29", "30-39", "40-49",
                               "50-59", "60-69", "70-79", "80-89", "90-100"))
# set levels for visits
...
or 2) AND passed late window

*Denominator:* Livebirth passed late window AND (has not closed out OR
...
tab_footnote(
  footnote = md("<span style='font-size: 18px'><sup>c</sup> denominator is n passed late window with >=64 weeks gestation OR closed out with closeout reason reported as: *1-year postpartum follow-up period has ended*.</span>")
  ) 
...
`MAT_VISIT_MNHXX`=1 or 2) AND passed late window

*Denominator:* Aim 3 enrolled livebirth passed late window AND (has not
