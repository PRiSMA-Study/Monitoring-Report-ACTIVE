...
### Table 17: Protocol compliance for ReMAPP fatigue assessment
...
### Table 18: Participant eligibility for the ReMAPP healthy cohort
...
### Table 19: Protocol compliance for ReMAPP hemoglobin measurements by CBC
...
<!-- `MAT_VISIT_MNHXX`=1 or 2) AND passed on time window -->
...
<!--   ) %>% -->
<!--   tab_row_group( -->
<!--     label = html("<span style='font-size: 18px'>3 month visit (On time window (+2 weeks): 13 to <17 weeks) (GSED required; FCI optional) <sup>a</sup></span>"), -->
<!--     rows = 1:4 -->
<!--   ) %>% -->
<!--   tab_row_group( -->
<!--     label = html("<span style='font-size: 18px'>6 month visit (On time window (+2 weeks): 26 to <30 weeks) (GSED & FCI optional) <sup>b</sup></span>"), -->
...
<!--     rows = 9:12 -->
<!--   ) %>% -->
<!--   row_group_order(groups = c("<span style='font-size: 18px'>3 month visit (On time window (+2 weeks): 13 to <17 weeks) (GSED required; FCI optional) <sup>a</sup></span>", -->
<!--                              "<span style='font-size: 18px'>6 month visit (On time window (+2 weeks): 26 to <30 weeks) (GSED & FCI optional) <sup>b</sup></span>", -->
<!--                              "<span style='font-size: 18px'>12 month visit (On time window (+2 weeks): 52 to <56 weeks) (GSED required; FCI optional) <sup>c</sup></span>" -->
<!--                              ))  %>% -->
<!-- tab_footnote( -->
<!--   footnote = html("<span style='font-size: 18px'><sup>a</sup> denominator is n passed late window with >=17 weeks gestation AND (has not closed out OR closed out with closeout date >=26wks).</span>") -->
<!-- ) %>% -->
<!--   tab_footnote( -->
<!--   footnote = html("<span style='font-size: 18px'><sup>b</sup> denominator is n passed late window with >=30 weeks gestation AND (has not closed out OR closed out with closeout date >=52wks).</span>") -->
<!-- ) %>% -->
<!--   tab_footnote( -->
<!--     footnote = md("<span style='font-size: 18px'><sup>c</sup> denominator is n passed late window with >=56 weeks gestation OR closed out with closeout -->
<!--   reason reported as: *1-year postpartum follow-up period has ended*.</span>") -->
<!--   ) -->
